...
class SubCategoryController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        $subcategory->save();
        return response()->json(['msg'=>'sub category added'],200);
    ...
    public function delete($id)
    {
        ...
        return response()->json(["status"=>0,"msg"=>$cat?'sub categroy deleted successfully':"sub category not found"],$cat?200:404);
    }
